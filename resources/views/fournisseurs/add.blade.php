...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Ajouter un nouveau fournisseur</h6>
        </div>
        <form method="POST" action="{{route('fournisseurs.store')}}">
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('fournisseurs.index') }}">Annuler</a>
            </div>
        </form>
    </div>
