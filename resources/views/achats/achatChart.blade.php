...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tresorerie-graphes</h1>
        
    </div>

    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center mb-3"><span class="kw" translate="no">Bienvenue</span></h2>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="card-body">
                            <div>
                            <div class="btn-group2" role="group" aria-label="Basic exemple">
                                <button type="button" data-group="day" class="btn btn-sm btn-success">Jour</button>
                                <button type="button" data-group="week" class="btn btn-sm btn-primary">Semaine</button>
                                <button type="button" data-group="month" class="btn btn-sm btn-danger">Mois</button>
                                <button type="button" data-group="year" class="btn btn-sm btn-secondary">Année</button>
...
<script>
  ...
  function displayChart(group ='month'){
    ...
    fetch("{{ route('achats.achatsChart') }}?group=" + group)
...
<script>
  ...
  function displayChart2(group ='month'){
  ...
  $('.btn-group2 .btn').on('click', function(e) {
    console.log($(this).data('group'));
    e.preventDefault();
    displayChart2($(this).data('group'));
  });
